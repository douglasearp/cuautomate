        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-8">
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#2D5016] pl-4 py-3 bg-[#2D5016]/5 rounded-r-lg">
                ...
                <div className="flex items-center space-x-4 text-xs">
                  <span className="text-[#2D5016] font-semibold">87% success probability</span>
                  <button className="text-[#2D5016] hover:underline">Apply Discount</button>
                </div>
              </div>
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              {mockTemplates.map((template) => (
                <div key={template.id} className="border border-gray-200 rounded-lg p-4 hover:border-[#2D5016] transition-colors">
                  ...
                  <div className="flex items-center space-x-2">
                    <button className="text-sm text-[#2D5016] hover:underline">Use Template</button>
        ...
        <div className="card mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {mockLineItemSuggestions.map((suggestion, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4 hover:border-[#2D5016] transition-colors">
                <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-sm text-[#2D5016] hover:underline">Add to Invoice</button>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2D5016] focus:border-transparent">
